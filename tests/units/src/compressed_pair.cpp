...
TEST(compressed_pair, constructor) {
    ...
    {
        cpi2 a;
        WJR_ASSERT_ALWAYS(a.first() == 0);
        WJR_ASSERT_ALWAYS(a.second() == 0);
        cpi2 b(default_construct, default_construct);
        cpi2 c(default_construct, 3);
        (void)(b);
        WJR_ASSERT_ALWAYS(c.second() == 3);

        a = std::make_pair(1, 2);
        WJR_ASSERT_ALWAYS(a.first() == 1);
        WJR_ASSERT_ALWAYS(a.second() == 2);

        a = std::make_tuple(3, 4);
        WJR_ASSERT_ALWAYS(a.first() == 3);
        WJR_ASSERT_ALWAYS(a.second() == 4);

        a = make_compressed_pair(5, 6);
        WJR_ASSERT_ALWAYS(a.first() == 5);
        WJR_ASSERT_ALWAYS(a.second() == 6);

        a = std::array<char, 2>{7, 8};
        WJR_ASSERT_ALWAYS(a.first() == 7);
        WJR_ASSERT_ALWAYS(a.second() == 8);
    }

    {
        ...
        WJR_ASSERT_ALWAYS(b.first() == 1);
        WJR_ASSERT_ALWAYS(b.second() == 3);

        auto [x, y] = a;
        WJR_ASSERT_ALWAYS(x == 1);
        WJR_ASSERT_ALWAYS(y == 2);
...

    {
        ...
        WJR_ASSERT_ALWAYS(b.first() == 1);
        WJR_ASSERT_ALWAYS(b.second() == 2);
        WJR_ASSERT_ALWAYS(c.first() == 1);
        WJR_ASSERT_ALWAYS(c.second() == 2);
        WJR_ASSERT_ALWAYS(d.first() == 1);
        WJR_ASSERT_ALWAYS(d.second() == 2);
    }

    {
        cpis a(1, "hello");
        WJR_ASSERT_ALWAYS(a.first() == 1);
        WJR_ASSERT_ALWAYS(a.second() == "hello");
    }
...

    {
        ...
        WJR_ASSERT_ALWAYS(b.second() == 3);
        WJR_ASSERT_ALWAYS(c.second() == 3);
        WJR_ASSERT_ALWAYS(d.second() == 3);
        WJR_ASSERT_ALWAYS(e.second() == 3);
    }
}