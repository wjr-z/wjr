...
#define WJR_PP_QUEUE_POP_FRONT_I11(x0, x1, x2, ...)                                      \
    WJR_PP_QUEUE_POP_FRONT_I8((__VA_ARGS__))
#define WJR_PP_QUEUE_POP_FRONT_I12(x0, x1, x2, x3, ...)                                  \
    WJR_PP_QUEUE_POP_FRONT_I8((__VA_ARGS__))
#define WJR_PP_QUEUE_POP_FRONT_I13(x0, x1, x2, x3, x4, ...)                              \
    WJR_PP_QUEUE_POP_FRONT_I8((__VA_ARGS__))
...
#define WJR_PP_QUEUE_POP_FRONT_I19(x0, x1, x2, ...)                                      \
    WJR_PP_QUEUE_POP_FRONT_I16((__VA_ARGS__))
#define WJR_PP_QUEUE_POP_FRONT_I20(x0, x1, x2, x3, ...)                                  \
    WJR_PP_QUEUE_POP_FRONT_I16((__VA_ARGS__))
...
#define WJR_PP_QUEUE_POP_FRONT_I27(x0, x1, x2, ...)                                      \
    WJR_PP_QUEUE_POP_FRONT_I24((__VA_ARGS__))
#define WJR_PP_QUEUE_POP_FRONT_I28(x0, x1, x2, x3, ...)                                  \
    WJR_PP_QUEUE_POP_FRONT_I24((__VA_ARGS__))
...
#define WJR_PP_QUEUE_POP_FRONT_I35(x0, x1, x2, ...)                                      \
    WJR_PP_QUEUE_POP_FRONT_I32((__VA_ARGS__))
#define WJR_PP_QUEUE_POP_FRONT_I36(x0, x1, x2, x3, ...)                                  \
    WJR_PP_QUEUE_POP_FRONT_I32((__VA_ARGS__))
...
#define WJR_PP_QUEUE_POP_FRONT_I43(x0, x1, x2, ...)                                      \
    WJR_PP_QUEUE_POP_FRONT_I40((__VA_ARGS__))
#define WJR_PP_QUEUE_POP_FRONT_I44(x0, x1, x2, x3, ...)                                  \
    WJR_PP_QUEUE_POP_FRONT_I40((__VA_ARGS__))
...
#define WJR_PP_QUEUE_POP_FRONT_I51(x0, x1, x2, ...)                                      \
    WJR_PP_QUEUE_POP_FRONT_I48((__VA_ARGS__))
#define WJR_PP_QUEUE_POP_FRONT_I52(x0, x1, x2, x3, ...)                                  \
    WJR_PP_QUEUE_POP_FRONT_I48((__VA_ARGS__))
...
#define WJR_PP_QUEUE_POP_FRONT_I59(x0, x1, x2, ...)                                      \
    WJR_PP_QUEUE_POP_FRONT_I56((__VA_ARGS__))
#define WJR_PP_QUEUE_POP_FRONT_I60(x0, x1, x2, x3, ...)                                  \
    WJR_PP_QUEUE_POP_FRONT_I56((__VA_ARGS__))
