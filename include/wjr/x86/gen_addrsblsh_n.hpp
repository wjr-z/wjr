...
inline uint64_t WJR_PP_CONCAT(asm_, WJR_PP_CONCAT(WJR_addsub, lsh_n))(
    ...
    asm volatile(
        ...
        "shlx{q %[cl], %[r10], %[r8]| %[r8], %[r10], %[cl]}\n\t"
        "lea{q (%[r9], %[r8]), %[r8]| %[r8], [%[r9] + %[r8]]}\n\t"
        "mov{q 24(%[src1]), %[r9]| %[r9], [%[src1] + 24]}\n\t"
        WJR_PP_STR(WJR_adcsbb) "{q 16(%[src0]), %[r8]| %[r8], [%[src0] + 16]}\n\t"
        "shrx{q %[tcl], %[r10], %[r10]| %[r10],%[r10], %[tcl]}\n\t"
        ...
        "shlx{q %[cl], %[r9], %[r8]| %[r8], %[r9], %[cl]}\n\t"
        "lea{q (%[r10], %[r8]), %[r8]| %[r8], [%[r10] + %[r8]]}\n\t"
        "mov{q 32(%[src1]), %[r10]| %[r10], [%[src1] + 32]}\n\t"
        WJR_PP_STR(WJR_adcsbb) "{q 24(%[src0]), %[r8]| %[r8], [%[src0] + 24]}\n\t"
        "shrx{q %[tcl], %[r9], %[r9]| %[r9],%[r9], %[tcl]}\n\t"
        ...
        WJR_PP_STR(WJR_adcsbb) "{q 32(%[src0]), %[r8]| %[r8], [%[src0] + 32]}\n\t"
        "shrx{q %[tcl], %[r10], %[r10]| %[r10],%[r10], %[tcl]}\n\t"
        ...
        "shlx{q %[cl], %[r10], %[r8]| %[r8], %[r10], %[cl]}\n\t"
        "lea{q (%[r9], %[r8]), %[r8]| %[r8], [%[r9] + %[r8]]}\n\t"
        "mov{q 56(%[src1]), %[r9]| %[r9], [%[src1] + 56]}\n\t"
        WJR_PP_STR(WJR_adcsbb) "{q 48(%[src0]), %[r8]| %[r8], [%[src0]+ 48]}\n\t"
        "shrx{q %[tcl], %[r10], %[r10]| %[r10],%[r10], %[tcl]}\n\t"
