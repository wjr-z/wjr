...
template <unsigned int IBase = 10, typename Converter = char_converter_t, WJR_REQUIRES(IBase <= 16)>
WJR_PURE WJR_INTRINSIC_INLINE bool check_eight_digits(const char *ptr,
