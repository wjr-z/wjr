...
inline constexpr uint64_t max_mantissa_double[] = {
    0x20000000000000,
    0x20000000000000 / 5,
...
struct powers_template {
    ...
    inline constexpr static uint64_t power_of_five_128[number_of_entries] = {
...
template <typename T>
adjusted_mantissa negative_digit_comp(biginteger &bigmant, adjusted_mantissa am,
                                      int32_t exponent) noexcept {
