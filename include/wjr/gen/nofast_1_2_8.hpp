...
#define WJR_GEN_SMALL_NOFAST_1_2_8(n, LOOP1, INIT1, RET, LARGE, ...)                     \
    do {                                                                                 \
        INIT1(0);                                                                        \
                                                                                         \
        if (WJR_UNLIKELY(n < 4)) {                                                       \
...
#define WJR_GEN_LARGE_NOFAST_1_2_8(gen_offset, gen_n, n, LOOP2, LOOP8, INIT2, INIT8,     \
                                   RET)                                                  \
    do {                                                                                 \
...
#define WJR_GEN_NOFAST_1_2_8(LOOP1, LOOP2, LOOP8, INIT1, INIT2, INIT8, RET)              \
    WJR_GEN_SMALL_NOFAST_1_2_8(n, LOOP1, INIT1, RET, WJR_GEN_LARGE_NOFAST_1_2_8, LOOP2,  \
