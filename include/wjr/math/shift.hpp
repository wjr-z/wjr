...
template <typename T>
WJR_INTRINSIC_CONSTEXPR_E T lshift_n(T *WJR_RESTRICT dst, const T *src, size_t n,
                                     unsigned int c, T lo = 0u) {
...
template <typename T>
WJR_INTRINSIC_CONSTEXPR_E T rshift_n(T *WJR_RESTRICT dst, const T *src, size_t n,
                                     unsigned int c, T hi = 0u) {
    WJR_ASSERT_ASSUME(n >= 1);
