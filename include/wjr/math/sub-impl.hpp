...
WJR_NODISCARD WJR_INTRINSIC_CONSTEXPR T subc(T a, T b, type_identity_t<U> c_in,
                                               U &c_out) noexcept;

template <nonbool_unsigned_integral T>
WJR_NODISCARD WJR_INTRINSIC_CONSTEXPR T subc_cc(T a, T b, uint8_t c_in, uint8_t &c_out) noexcept;

template <nonbool_unsigned_integral T>
WJR_NODISCARD WJR_INTRINSIC_CONSTEXPR bool sub_overflow(type_identity_t<T> a,
