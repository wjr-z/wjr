...
template <>
struct simd_cast_fn<_m128_t, _m128i_t> {
...
template <>
struct simd_cast_fn<_m128_t, _m128d_t> {
...
template <>
struct simd_cast_fn<_m128i_t, _m128_t> {
...
template <>
struct simd_cast_fn<_m128i_t, _m128d_t> {
...
template <>
struct simd_cast_fn<_m128d_t, _m128_t> {
...
template <>
struct simd_cast_fn<_m128d_t, _m128i_t> {
...
template <>
struct simd_cast_fn<int8_t, _m128i_t> {
...
template <>
struct simd_cast_fn<uint8_t, _m128i_t> {
...
template <>
struct simd_cast_fn<_m128i_t, int8_t> {
...
template <>
struct simd_cast_fn<_m128i_t, uint8_t> {
...
template <>
struct simd_cast_fn<int16_t, _m128i_t> {
...
template <>
struct simd_cast_fn<uint16_t, _m128i_t> {
...
template <>
struct simd_cast_fn<_m128i_t, int16_t> {
...
template <>
struct simd_cast_fn<_m128i_t, uint16_t> {
...
template <>
struct simd_cast_fn<int32_t, _m128i_t> {
...
template <>
struct simd_cast_fn<uint32_t, _m128i_t> {
...
template <>
struct simd_cast_fn<_m128i_t, int32_t> {
...
template <>
struct simd_cast_fn<_m128i_t, uint32_t> {
...
template <>
struct simd_cast_fn<int64_t, _m128i_t> {
...
template <>
struct simd_cast_fn<uint64_t, _m128i_t> {
...
template <>
struct simd_cast_fn<_m128i_t, int64_t> {
...
template <>
struct simd_cast_fn<_m128i_t, uint64_t> {
...
template <>
struct simd_cast_fn<_m256_t, _m256i_t> {
...
template <>
struct simd_cast_fn<_m256_t, _m256d_t> {
...
template <>
struct simd_cast_fn<_m256i_t, _m256_t> {
...
template <>
struct simd_cast_fn<_m256i_t, _m256d_t> {
...
template <>
struct simd_cast_fn<_m256d_t, _m256_t> {
...
template <>
struct simd_cast_fn<_m256d_t, _m256i_t> {
...
template <>
struct simd_cast_fn<_m128i_t, _m256i_t> {
...
template <>
struct simd_cast_fn<_m256i_t, _m128i_t> {
...
template <>
struct simd_cast_fn<int8_t, _m256i_t> {
    WJR_CONST WJR_INTRINSIC_INLINE __m256i operator()(int8_t v) const noexcept {
        return simd_cast<_m128i_t, _m256i_t>(simd_cast<int8_t, _m128i_t>(v));
    }
};

template <>
struct simd_cast_fn<uint8_t, _m256i_t> {
    WJR_CONST WJR_INTRINSIC_INLINE __m256i operator()(uint8_t v) const noexcept {
        return simd_cast<_m128i_t, _m256i_t>(simd_cast<uint8_t, _m128i_t>(v));
    }
};

template <>
struct simd_cast_fn<_m256i_t, int8_t> {
    WJR_CONST WJR_INTRINSIC_INLINE int8_t operator()(__m256i v) const noexcept {
        return simd_cast<_m128i_t, int8_t>(simd_cast<_m256i_t, _m128i_t>(v));
    }
};

template <>
struct simd_cast_fn<_m256i_t, uint8_t> {
    WJR_CONST WJR_INTRINSIC_INLINE uint8_t operator()(__m256i v) const noexcept {
        return simd_cast<_m128i_t, uint8_t>(simd_cast<_m256i_t, _m128i_t>(v));
    }
};

template <>
struct simd_cast_fn<int16_t, _m256i_t> {
    WJR_CONST WJR_INTRINSIC_INLINE __m256i operator()(int16_t v) const noexcept {
        return simd_cast<_m128i_t, _m256i_t>(simd_cast<int16_t, _m128i_t>(v));
    }
};

template <>
struct simd_cast_fn<uint16_t, _m256i_t> {
    WJR_CONST WJR_INTRINSIC_INLINE __m256i operator()(uint16_t v) const noexcept {
        return simd_cast<_m128i_t, _m256i_t>(simd_cast<uint16_t, _m128i_t>(v));
    }
};

template <>
struct simd_cast_fn<_m256i_t, int16_t> {
    WJR_CONST WJR_INTRINSIC_INLINE int16_t operator()(__m256i v) const noexcept {
        return simd_cast<_m128i_t, int16_t>(simd_cast<_m256i_t, _m128i_t>(v));
    }
};

template <>
struct simd_cast_fn<_m256i_t, uint16_t> {
    WJR_CONST WJR_INTRINSIC_INLINE uint16_t operator()(__m256i v) const noexcept {
        return simd_cast<_m128i_t, uint16_t>(simd_cast<_m256i_t, _m128i_t>(v));
    }
};

template <>
struct simd_cast_fn<int32_t, _m256i_t> {
    WJR_CONST WJR_INTRINSIC_INLINE __m256i operator()(int32_t v) const noexcept {
        return simd_cast<_m128i_t, _m256i_t>(simd_cast<int32_t, _m128i_t>(v));
    }
};

template <>
struct simd_cast_fn<uint32_t, _m256i_t> {
    WJR_CONST WJR_INTRINSIC_INLINE __m256i operator()(uint32_t v) const noexcept {
        return simd_cast<_m128i_t, _m256i_t>(simd_cast<uint32_t, _m128i_t>(v));
    }
};

template <>
struct simd_cast_fn<_m256i_t, int32_t> {
    WJR_CONST WJR_INTRINSIC_INLINE int32_t operator()(__m256i v) const noexcept {
        return simd_cast<_m128i_t, int32_t>(simd_cast<_m256i_t, _m128i_t>(v));
    }
};

template <>
struct simd_cast_fn<_m256i_t, uint32_t> {
    WJR_CONST WJR_INTRINSIC_INLINE uint32_t operator()(__m256i v) const noexcept {
        return simd_cast<_m128i_t, uint32_t>(simd_cast<_m256i_t, _m128i_t>(v));
    }
};

template <>
struct simd_cast_fn<int64_t, _m256i_t> {
    WJR_CONST WJR_INTRINSIC_INLINE __m256i operator()(int64_t v) const noexcept {
        return simd_cast<_m128i_t, _m256i_t>(simd_cast<int64_t, _m128i_t>(v));
    }
};

template <>
struct simd_cast_fn<uint64_t, _m256i_t> {
    WJR_CONST WJR_INTRINSIC_INLINE __m256i operator()(uint64_t v) const noexcept {
        return simd_cast<_m128i_t, _m256i_t>(simd_cast<uint64_t, _m128i_t>(v));
    }
};

template <>
struct simd_cast_fn<_m256i_t, int64_t> {
    WJR_CONST WJR_INTRINSIC_INLINE int64_t operator()(__m256i v) const noexcept {
        return simd_cast<_m128i_t, int64_t>(simd_cast<_m256i_t, _m128i_t>(v));
    }
};

template <>
struct simd_cast_fn<_m256i_t, uint64_t> {
    WJR_CONST WJR_INTRINSIC_INLINE uint64_t operator()(__m256i v) const noexcept {
        return simd_cast<_m128i_t, uint64_t>(simd_cast<_m256i_t, _m128i_t>(v));
    }
};
