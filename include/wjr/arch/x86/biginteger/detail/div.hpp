#ifndef WJR_ARCH_X86_BIGINTEGER_DETAIL_DIV_HPP__
#define WJR_ARCH_X86_BIGINTEGER_DETAIL_DIV_HPP__
...
namespace wjr {
        ...
        #define WJR_HAS_BUILTIN_ASM_DIVEXACT_DBM1C WJR_HAS_ASSEMBLY_DEF
    #endif
#endif
...
extern "C" WJR_ALL_NONNULL WJR_MS_ABI uint64_t __wjr_asm_divexact_dbm1c(uint64_t *dst,
                                                                        const uint64_t *src,
...
#endif // WJR_ARCH_X86_BIGINTEGER_DETAIL_DIV_HPP__