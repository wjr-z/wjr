...
#if defined(__SSE2__)
	__SIMD_INLINE __m128 operator()(__m128i v)const {
		return _mm_castsi128_ps(v);
	}
	__SIMD_INLINE __m128 operator()(__m128d v)const {
...
struct __simd_cast<__m128i> {
	__SIMD_INLINE __m128i operator()(__m128 v)const {
		return _mm_castps_si128(v);
	}
	__SIMD_INLINE __m128i operator()(__m128d v)const {
		return _mm_castpd_si128(v);
	}
#if defined(__AVX__)
	__SIMD_INLINE __m128i operator()(__m256i v)const {
...
struct __simd_cast<__m128d> {
	__SIMD_INLINE __m128d operator()(__m128 v)const {
		return _mm_castps_pd(v);
	}
	__SIMD_INLINE __m128d operator()(__m128i v)const {
...
struct __simd_cast<__m256i> {
	__SIMD_INLINE __m256i operator()(__m128i v)const {
...
#if defined(__SSE2__)
	__SIMD_INLINE uint64_t operator()(__m128i v)const {
		return _mm_cvtsi128_si64(v);
	}
#endif // __SSE2__
#if defined(__AVX__)
	__SIMD_INLINE uint64_t operator()(__m256i v)const {
...
#if defined(__SSE2__)
	__SIMD_INLINE int64_t operator()(__m128i v)const {
		return simd_cast<uint64_t>(v);
	}
#endif // __SSE2__
#if defined(__AVX__)
	__SIMD_INLINE int64_t operator()(__m256i v)const {
		return simd_cast<uint64_t>(v);
	}
#endif // __AVX__
};
...
public:
	...
	__SIMD_INLINE static simd_type add_ps(simd_type a, simd_type b) { return _mm_add_ps(a, b); }
	__SIMD_INLINE static simd_type add_ss(simd_type a, simd_type b) { return _mm_add_ss(a, b); }

	__SIMD_INLINE static simd_type and_ps(simd_type a, simd_type b) { return _mm_and_ps(a, b); }
	__SIMD_INLINE static simd_type andnot_ps(simd_type a, simd_type b) { return _mm_andnot_ps(a, b); }

	__SIMD_INLINE static simd_type cmpeq_ps(simd_type a, simd_type b) { return _mm_cmpeq_ps(a, b); }
	__SIMD_INLINE static simd_type cmpeq_ss(simd_type a, simd_type b) { return _mm_cmpeq_ss(a, b); }

	__SIMD_INLINE static simd_type cmpge_ps(simd_type a, simd_type b) { return _mm_cmpge_ps(a, b); }
	__SIMD_INLINE static simd_type cmpge_ss(simd_type a, simd_type b) { return _mm_cmpge_ss(a, b); }
};
...
public:
	...
	__SIMD_INLINE static simd_type set_epi8(
	...
	__SIMD_INLINE static simd_type set_epi16(short e7, short e6, short e5, short e4, short e3, short e2, short e1, short e0) { 
		return _mm_set_epi16(e7, e6, e5, e4, e3, e2, e1, e0); 
	}
	__SIMD_INLINE static simd_type set_epi32(int e3, int e2, int e1, int e0) {
		return _mm_set_epi32(e3, e2, e1, e0);
	}
	__SIMD_INLINE static simd_type set_epi64x(long long e1, long long e0) {
		return _mm_set_epi64x(e1, e0);
	}

	__SIMD_INLINE static simd_type setr_epi8(
		char e15, char e14, char e13, char e12, char e11, char e10, char e9, char e8, 
		char e7, char e6, char e5, char e4, char e3, char e2, char e1, char e0) {
		return _mm_setr_epi8(e15, e14, e13, e12, e11, e10, e9, e8, e7, e6, e5, e4, e3, e2, e1, e0);
	}

	__SIMD_INLINE static simd_type setr_epi16(short e7, short e6, short e5, short e4, short e3, short e2, short e1, short e0) {
		return _mm_setr_epi16(e7, e6, e5, e4, e3, e2, e1, e0);
	}
	__SIMD_INLINE static simd_type setr_epi32(int e3, int e2, int e1, int e0) {
		return _mm_setr_epi32(e3, e2, e1, e0);
	}

	__SIMD_INLINE static simd_type set1_epi8(int8_t val) { return _mm_set1_epi8(val); }
	__SIMD_INLINE static simd_type set1_epi16(int16_t val) { return _mm_set1_epi16(val); }
	__SIMD_INLINE static simd_type set1_epi32(int32_t val) { return _mm_set1_epi32(val); }
	__SIMD_INLINE static simd_type set1_epi64(int64_t val) { return _mm_set1_epi64x(val); }
	...
	__SIMD_INLINE static simd_type setmin_epi8() { return set1_epi8(0x80u); }
	__SIMD_INLINE static simd_type setmin_epi16() { return set1_epi16(0x8000u); }
	__SIMD_INLINE static simd_type setmin_epi32() { return set1_epi32(0x80000000u); }
	...
	__SIMD_INLINE static simd_type setmin(uint8_t) { return set1_epi32(0); }
	__SIMD_INLINE static simd_type setmin(uint16_t) { return set1_epi32(0); }
	__SIMD_INLINE static simd_type setmin(uint32_t) { return set1_epi32(0); }
	...
	__SIMD_INLINE static simd_type setmax(uint8_t) { return set1_epi32(0xFFFFFFFF); }
	__SIMD_INLINE static simd_type setmax(uint16_t) { return set1_epi32(0xFFFFFFFF); }
	__SIMD_INLINE static simd_type setmax(uint32_t) { return set1_epi32(0xFFFFFFFF); }
	...
	__SIMD_INLINE static uint8_t add_epu8(simd_type a) {
	...
	__SIMD_INLINE static uint16_t add_epu16(simd_type a) {
	...
	__SIMD_INLINE static uint32_t add_epu32(simd_type a) {
	...
	__SIMD_INLINE static uint64_t add_epu64(simd_type a) {
		a = add_epi64(a, shuffle_epi32<_MM_SHUFFLE(3, 2, 3, 2)>(a));
		return simd_cast<uint64_t>(a);
	}
	__SIMD_INLINE static int8_t add_epi8(simd_type a) { return add_epu8(a); }
	__SIMD_INLINE static int16_t add_epi16(simd_type a) { return add_epu16(a); }
	__SIMD_INLINE static int32_t add_epi32(simd_type a) { return add_epu32(a); }
	__SIMD_INLINE static int64_t add_epi64(simd_type a) { return add_epu64(a); }
	...
	__SIMD_INLINE static int64_t add(simd_type a, int64_t) { return add_epi64(a); }
	__SIMD_INLINE static uint8_t add(simd_type a, uint8_t) { return add_epu8(a); }
	__SIMD_INLINE static uint16_t add(simd_type a, uint16_t) { return add_epu16(a); }
	__SIMD_INLINE static uint32_t add(simd_type a, uint32_t) { return add_epu32(a); }
	__SIMD_INLINE static uint64_t add(simd_type a, uint64_t) { return add_epu64(a); }
...
#if defined(__SSSE3__)
	template<int imm8>
	__SIMD_INLINE static simd_type alignr_epi8(simd_type lhs, simd_type rhs) { return _mm_alignr_epi8(lhs, rhs, imm8); }
#endif // __SSSE3__
	...
	template<int imm8>
	__SIMD_INLINE static simd_type blend_epi16(simd_type lhs, simd_type rhs) { return _mm_blend_epi16(lhs, rhs, imm8); }
	...
	__SIMD_INLINE static simd_type cmpne_epi8(simd_type lhs, simd_type rhs) { return Not(cmpeq_epi8(lhs, rhs)); }
	__SIMD_INLINE static simd_type cmpne_epi16(simd_type lhs, simd_type rhs) { return Not(cmpeq_epi16(lhs, rhs)); }
	__SIMD_INLINE static simd_type cmpne_epi32(simd_type lhs, simd_type rhs) { return Not(cmpeq_epi32(lhs, rhs)); }

	__SIMD_INLINE static simd_type cmpne(simd_type lhs, simd_type rhs, int8_t) { return cmpne_epi8(lhs, rhs); }
	__SIMD_INLINE static simd_type cmpne(simd_type lhs, simd_type rhs, int16_t) { return cmpne_epi16(lhs, rhs); }
	__SIMD_INLINE static simd_type cmpne(simd_type lhs, simd_type rhs, int32_t) { return cmpne_epi32(lhs, rhs); }
	__SIMD_INLINE static simd_type cmpne(simd_type lhs, simd_type rhs, uint8_t) { return cmpne_epi8(lhs, rhs); }
	__SIMD_INLINE static simd_type cmpne(simd_type lhs, simd_type rhs, uint16_t) { return cmpne_epi16(lhs, rhs); }
	__SIMD_INLINE static simd_type cmpne(simd_type lhs, simd_type rhs, uint32_t) { return cmpne_epi32(lhs, rhs); }

	template<typename T>
	__SIMD_INLINE static simd_type cmp(simd_type lhs, simd_type rhs, std::equal_to<>, T) {
		return cmpeq(lhs, rhs, T{});
	}
	template<typename T>
	__SIMD_INLINE static simd_type cmp(simd_type lhs, simd_type rhs, std::not_equal_to<>, T) {
		return cmpne(lhs, rhs, T{});
	}
	template<typename T>
	__SIMD_INLINE static simd_type cmp(simd_type lhs, simd_type rhs, std::greater<>, T) {
		return cmpgt(lhs, rhs, T{});
	}
	template<typename T>
	__SIMD_INLINE static simd_type cmp(simd_type lhs, simd_type rhs, std::greater_equal<>, T) {
		return cmpge(lhs, rhs, T{});
	}
	template<typename T>
	__SIMD_INLINE static simd_type cmp(simd_type lhs, simd_type rhs, std::less<>, T) {
		return cmplt(lhs, rhs, T{});
	}
	template<typename T>
	__SIMD_INLINE static simd_type cmp(simd_type lhs, simd_type rhs, std::less_equal<>, T) {
...
#if defined(__SSE4_1__)
	__SIMD_INLINE static simd_type minpos_epu16(simd_type a) { return _mm_minpos_epu16(a); }
#endif // __SSE4_1__
...
#if defined(__SSSE3__)
	__SIMD_INLINE static simd_type shuffle_epi8(simd_type v, simd_type imm8) {
	...
	__SIMD_INLINE static simd_type preload_si16(const void* ptr) { return loadu_si16(ptr); }
	__SIMD_INLINE static simd_type preload_si32(const void* ptr) { return loadu_si32(ptr); }
	__SIMD_INLINE static simd_type preload_si48(const void* ptr) {
		return insert_epi16<2>(preload_si32(ptr), reinterpret_cast<const uint16_t*>(ptr)[2]);
	}
	__SIMD_INLINE static simd_type preload_si64(const void* ptr) { return loadu_si64(ptr); }
	__SIMD_INLINE static simd_type preload_si80(const void* ptr) {
		return insert_epi16<4>(preload_si64(ptr), reinterpret_cast<const uint16_t*>(ptr)[4]);
	}
	__SIMD_INLINE static simd_type preload_si96(const void* ptr) {
#if defined(__SSE4_1__)
	...
	__SIMD_INLINE static simd_type preload_si112(const void* ptr) {
		return insert_epi16<6>(preload_si96(ptr), reinterpret_cast<const uint16_t*>(ptr)[6]);
	}
	__SIMD_INLINE static simd_type preload_si128(const void* ptr) { return loadu_all((simd_type*)ptr); }

	__SIMD_INLINE static simd_type preload_si16x(const void* ptr, int n) {
		// preload_si(n * 16)
		switch (n) {
...
public:
	...
	__SIMD_INLINE static simd_type set_all_zeros() { return _mm256_setzero_si256(); }
	__SIMD_INLINE static simd_type set_all_ones() { return _mm256_set1_epi32(-1); }

	__SIMD_INLINE static simd_type zextsi128_si256(__m128i v) { return _mm256_zextsi128_si256(v); }
	...
	__SIMD_INLINE static simd_type set_epi16(
	...
	__SIMD_INLINE static simd_type setr_epi16(
		short e15, short e14, short e13, short e12, short e11, short e10, short e9, short e8,
		short e7, short e6, short e5, short e4, short e3, short e2, short e1, short e0) {
	...
	__SIMD_INLINE static simd_type setr_epi32(
		int e7, int e6, int e5, int e4, int e3, int e2, int e1, int e0) {
		return _mm256_setr_epi32(e7, e6, e5, e4, e3, e2, e1, e0);
	}
	__SIMD_INLINE static simd_type setr_epi64x(
		long long e3, long long e2, long long e1, long long e0) {
	...
	__SIMD_INLINE static simd_type set1_epi64(int64_t a) { return _mm256_set1_epi64x(a); }
	...
	__SIMD_INLINE static simd_type set1(int64_t a, int64_t) { return set1_epi64(a); }
	...
	__SIMD_INLINE static simd_type set1(uint64_t a, uint64_t) { return set1_epi64(a); }

	__SIMD_INLINE static simd_type setmin_epi8() { return set1_epi8(0x80u); }
	__SIMD_INLINE static simd_type setmin_epi16() { return set1_epi16(0x8000u); }
	__SIMD_INLINE static simd_type setmin_epi32() { return set1_epi32(0x80000000u); }
	__SIMD_INLINE static simd_type setmin_epi64() { return set1_epi64(0x8000000000000000ull); }

	__SIMD_INLINE static simd_type setmin(int8_t) { return setmin_epi8(); }
	__SIMD_INLINE static simd_type setmin(int16_t) { return setmin_epi16(); }
	__SIMD_INLINE static simd_type setmin(int32_t) { return setmin_epi32(); }
	__SIMD_INLINE static simd_type setmin(int64_t) { return setmin_epi64(); }

	__SIMD_INLINE static simd_type setmax_epi8() { return set1_epi8(0x7f); }
	__SIMD_INLINE static simd_type setmax_epi16() { return set1_epi16(0x7fff); }
	__SIMD_INLINE static simd_type setmax_epi32() { return set1_epi32(0x7fffffff); }
	__SIMD_INLINE static simd_type setmax_epi64() { return set1_epi64(0x7fffffffffffffff); }

	__SIMD_INLINE static simd_type setmax(int8_t) { return setmax_epi8(); }
	__SIMD_INLINE static simd_type setmax(int16_t) { return setmax_epi16(); }
	__SIMD_INLINE static simd_type setmax(int32_t) { return setmax_epi32(); }
	__SIMD_INLINE static simd_type setmax(int64_t) { return setmax_epi64(); }
	...
	__SIMD_INLINE static simd_type Not(simd_type v) { return _mm256_xor_si256(v, set_all_ones()); }

	__SIMD_INLINE static simd_type abs_epi8(simd_type v) { return _mm256_abs_epi8(v); }
	__SIMD_INLINE static simd_type abs_epi16(simd_type v) { return _mm256_abs_epi16(v); }
	__SIMD_INLINE static simd_type abs_epi32(simd_type v) { return _mm256_abs_epi32(v); }

	__SIMD_INLINE static simd_type abs(simd_type v, int8_t) { return abs_epi8(v); }
	__SIMD_INLINE static simd_type abs(simd_type v, int16_t) { return abs_epi16(v); }
	__SIMD_INLINE static simd_type abs(simd_type v, int32_t) { return abs_epi32(v); }
	__SIMD_INLINE static simd_type abs(simd_type v, int64_t) { return abs_epi32(v); }
	...
	__SIMD_INLINE static uint8_t add_epu8(simd_type v) {
		return sse_traits_t<simd_integer>::add_epu8(sse_traits_t<simd_integer>::add_epi8( getlow_si128(v), gethigh_si128(v)));
	}
	__SIMD_INLINE static uint16_t add_epu16(simd_type v) {
		return sse_traits_t<simd_integer>::add_epu16(sse_traits_t<simd_integer>::add_epi16(getlow_si128(v), gethigh_si128(v)));
	}
	__SIMD_INLINE static uint32_t add_epu32(simd_type v) {
		return sse_traits_t<simd_integer>::add_epu32(sse_traits_t<simd_integer>::add_epi32(getlow_si128(v), gethigh_si128(v)));
	}
	__SIMD_INLINE static uint64_t add_epu64(simd_type v) {
		return sse_traits_t<simd_integer>::add_epu64(sse_traits_t<simd_integer>::add_epi64(getlow_si128(v), gethigh_si128(v)));
	}
	__SIMD_INLINE static int8_t add_epi8(simd_type v) { return add_epu8(v); }
	__SIMD_INLINE static int16_t add_epi16(simd_type v) { return add_epu16(v); }
	__SIMD_INLINE static int32_t add_epi32(simd_type v) { return add_epu32(v); }
	__SIMD_INLINE static int64_t add_epi64(simd_type v) { return add_epu64(v); }
	
	__SIMD_INLINE static int8_t add(simd_type v, int8_t) { return add_epi8(v); }
	__SIMD_INLINE static int16_t add(simd_type v, int16_t) { return add_epi16(v); }
	__SIMD_INLINE static int32_t add(simd_type v, int32_t) { return add_epi32(v); }
	__SIMD_INLINE static int64_t add(simd_type v, int64_t) { return add_epi64(v); }
	__SIMD_INLINE static uint8_t add(simd_type v, uint8_t) { return add_epu8(v); }
	__SIMD_INLINE static uint16_t add(simd_type v, uint16_t) { return add_epu16(v); }
	__SIMD_INLINE static uint32_t add(simd_type v, uint32_t) { return add_epu32(v); }
	__SIMD_INLINE static uint64_t add(simd_type v, uint64_t) { return add_epu64(v); }
	...
	template<int imm8>
	__SIMD_INLINE static simd_type alignr(simd_type lhs, simd_type rhs) { return _mm256_alignr_epi8(lhs, rhs, imm8); }
	...
	template<int imm8>
	__SIMD_INLINE static simd_type blend_epi16(simd_type lhs, simd_type rhs) { return _mm256_blend_epi16(lhs, rhs, imm8); }
	template<int imm8>
	__SIMD_INLINE static simd_type blend_epi32(simd_type lhs, simd_type rhs) { return _mm256_blend_epi32(lhs, rhs, imm8); }
	...
	template<int imm8>
	__SIMD_INLINE static simd_type bslli_epi128(simd_type lhs) { return _mm256_bslli_epi128(lhs, imm8); }

	template<int imm8>
	__SIMD_INLINE static simd_type bsrli_epi128(simd_type lhs) { return _mm256_bsrli_epi128(lhs, imm8); }
	...
	__SIMD_INLINE static simd_type cmpeq_epi64(simd_type lhs, simd_type rhs) { return _mm256_cmpeq_epi64(lhs, rhs); }
	...
	__SIMD_INLINE static simd_type cmpgt_epi64(simd_type lhs, simd_type rhs) { return _mm256_cmpgt_epi64(lhs, rhs); }
	...
	__SIMD_INLINE static simd_type cmpgt_epu64(simd_type lhs, simd_type rhs) {
#if defined(__XOP__)
	...
	__SIMD_INLINE static simd_type cmpgt(simd_type lhs, simd_type rhs, int16_t) { return cmpgt_epi16(lhs, rhs); }
	__SIMD_INLINE static simd_type cmpgt(simd_type lhs, simd_type rhs, int32_t) { return cmpgt_epi32(lhs, rhs); }
	__SIMD_INLINE static simd_type cmpgt(simd_type lhs, simd_type rhs, int64_t) { return cmpgt_epi64(lhs, rhs); }
	__SIMD_INLINE static simd_type cmpgt(simd_type lhs, simd_type rhs, uint8_t) { return cmpgt_epu8(lhs, rhs); }
	__SIMD_INLINE static simd_type cmpgt(simd_type lhs, simd_type rhs, uint16_t) { return cmpgt_epu16(lhs, rhs); }
	__SIMD_INLINE static simd_type cmpgt(simd_type lhs, simd_type rhs, uint32_t) { return cmpgt_epu32(lhs, rhs); }
	__SIMD_INLINE static simd_type cmpgt(simd_type lhs, simd_type rhs, uint64_t) { return cmpgt_epu64(lhs, rhs); }
	...
	template<typename T>
	__SIMD_INLINE static simd_type cvtepu8(__m128i v);
	template<typename T>
	__SIMD_INLINE static simd_type cvtepu16(__m128i v);
	template<typename T>
	__SIMD_INLINE static simd_type cvtepu32(__m128i v);

	template<typename T>
	__SIMD_INLINE static simd_type cvtepu(__m128i v, int8_t) { return cvtepu8<T>(v); }
	template<typename T>
	__SIMD_INLINE static simd_type cvtepu(__m128i v, int16_t) { return cvtepu16<T>(v); }
	template<typename T>
	__SIMD_INLINE static simd_type cvtepu(__m128i v, int32_t) { return cvtepu32<T>(v); }
	template<typename T>
	__SIMD_INLINE static simd_type cvtepu(__m128i v, uint8_t) { return cvtepu8<T>(v); }
	template<typename T>
	__SIMD_INLINE static simd_type cvtepu(__m128i v, uint16_t) { return cvtepu16<T>(v); }
	template<typename T>
	__SIMD_INLINE static simd_type cvtepu(__m128i v, uint32_t) { return cvtepu32<T>(v); }

	template<int imm8>
	__SIMD_INLINE static int extract_epi8(simd_type v) { return _mm256_extract_epi8(v, imm8); }
	template<int imm8>
	__SIMD_INLINE static int extract_epi16(simd_type v) { return _mm256_extract_epi16(v, imm8); }
#endif // __AVX2__
	template<int imm8>
	__SIMD_INLINE static int extract_epi32(simd_type v) { return _mm256_extract_epi32(v, imm8); }
	template<int imm8>
	__SIMD_INLINE static int64_t extract_epi64(simd_type v) { return _mm256_extract_epi64(v, imm8); }

#if defined(__AVX2__)
	template<int imm8>
	__SIMD_INLINE static int extract(simd_type v, int8_t) { return extract_epi8<imm8>(v); }
	template<int imm8>
	__SIMD_INLINE static int extract(simd_type v, int16_t) { return extract_epi16<imm8>(v); }
#endif // __AVX2__
	template<int imm8>
	__SIMD_INLINE static int extract(simd_type v, int32_t) { return extract_epi32<imm8>(v); }
	template<int imm8>
	__SIMD_INLINE static int64_t extract(simd_type v, int64_t) { return extract_epi64<imm8>(v); }

	template<int imm8>
	__SIMD_INLINE static __m128i extract_si128(simd_type v) { 
#if defined(__AVX2__)
...
#if defined(__AVX2__)
	__SIMD_INLINE static simd_type hadd_epi16(simd_type lhs, simd_type rhs) { return _mm256_hadd_epi16(lhs, rhs); }
	__SIMD_INLINE static simd_type hadd_epi32(simd_type lhs, simd_type rhs) { return _mm256_hadd_epi32(lhs, rhs); }

	__SIMD_INLINE static simd_type hadd(simd_type lhs, simd_type rhs, int16_t) { return hadd_epi16(lhs, rhs); }
	__SIMD_INLINE static simd_type hadd(simd_type lhs, simd_type rhs, int32_t) { return hadd_epi32(lhs, rhs); }

	__SIMD_INLINE static simd_type hadds_epi16(simd_type lhs, simd_type rhs) { return _mm256_hadds_epi16(lhs, rhs); }

	__SIMD_INLINE static simd_type hsub_epi16(simd_type lhs, simd_type rhs) { return _mm256_hsub_epi16(lhs, rhs); }
	__SIMD_INLINE static simd_type hsub_epi32(simd_type lhs, simd_type rhs) { return _mm256_hsub_epi32(lhs, rhs); }

	__SIMD_INLINE static simd_type hsub(simd_type lhs, simd_type rhs, int16_t) { return hsub_epi16(lhs, rhs); }
	__SIMD_INLINE static simd_type hsub(simd_type lhs, simd_type rhs, int32_t) { return hsub_epi32(lhs, rhs); }

	__SIMD_INLINE static simd_type hsubs_epi16(simd_type lhs, simd_type rhs) { return _mm256_hsubs_epi16(lhs, rhs); }

#endif // __AVX2__

	template<int imm8>
	__SIMD_INLINE static simd_type insert_epi8(simd_type v, int8_t i) { return _mm256_insert_epi8(v, i, imm8); }
	template<int imm8>
	__SIMD_INLINE static simd_type insert_epi16(simd_type v, int16_t i) { return _mm256_insert_epi16(v, i, imm8); }
	template<int imm8>
	__SIMD_INLINE static simd_type insert_epi32(simd_type v, int32_t i) { return _mm256_insert_epi32(v, i, imm8); }
	template<int imm8>
	__SIMD_INLINE static simd_type insert_epi64(simd_type v, int64_t i) { return _mm256_insert_epi64(v, i, imm8); }

	template<int imm8>
	__SIMD_INLINE static simd_type insert_si128(simd_type a, __m128i b) { 
#if defined(__AVX2__)
	...
	__SIMD_INLINE static simd_type shuffle_epi8(simd_type lhs, simd_type rhs) {
		return _mm256_shuffle_epi8(lhs, rhs);
	}
	template<int imm8>
	__SIMD_INLINE static simd_type shuffle_epi32(simd_type a) {
		return _mm256_shuffle_epi32(a, imm8);
	}
	
	template<int imm8>
	__SIMD_INLINE static simd_type shufflehi_epi16(simd_type a) {
		return _mm256_shufflehi_epi16(a, imm8);
	}

	template<int imm8>
	__SIMD_INLINE static simd_type shufflelo_epi16(simd_type a) {
	...
	__SIMD_INLINE static simd_type connect(__m128i a, __m128i b) {
		return insert_si128<1>(simd_cast<__m256i>(a), b);
	}

	__SIMD_INLINE static simd_type preload_si16(const void* ptr) {
		return zextsi128_si256(sse_traits_t<simd_integer>::preload_si16(ptr));
	}
	__SIMD_INLINE static simd_type preload_si32(const void* ptr) {
	...
	__SIMD_INLINE static simd_type preload_si64(const void* ptr) {
	...
	__SIMD_INLINE static simd_type preload_si128(const void* ptr) {
		return zextsi128_si256(sse_traits_t<simd_integer>::preload_si128(ptr));
	}
	__SIMD_INLINE static simd_type preload_si144(const void* ptr) {
		return connect(sse_traits_t<simd_integer>::preload_si128(ptr), 
			sse_traits_t<simd_integer>::preload_si16((const char*)ptr + 16));
	}
	__SIMD_INLINE static simd_type preload_si160(const void* ptr) {
		return connect(sse_traits_t<simd_integer>::preload_si128(ptr),
			sse_traits_t<simd_integer>::preload_si32((const char*)ptr + 16));
	}
	__SIMD_INLINE static simd_type preload_si176(const void* ptr) {
		return connect(sse_traits_t<simd_integer>::preload_si128(ptr),
			sse_traits_t<simd_integer>::preload_si48((const char*)ptr + 16));
	}
	__SIMD_INLINE static simd_type preload_si192(const void* ptr) {
		return connect(sse_traits_t<simd_integer>::preload_si128(ptr),
			sse_traits_t<simd_integer>::preload_si64((const char*)ptr + 16));
	}
	__SIMD_INLINE static simd_type preload_si208(const void* ptr) {
		return connect(sse_traits_t<simd_integer>::preload_si128(ptr),
			sse_traits_t<simd_integer>::preload_si80((const char*)ptr + 16));
	}
	__SIMD_INLINE static simd_type preload_si224(const void* ptr) {
		return connect(sse_traits_t<simd_integer>::preload_si128(ptr),
			sse_traits_t<simd_integer>::preload_si96((const char*)ptr + 16));
	}
	__SIMD_INLINE static simd_type preload_si240(const void* ptr) {
		return connect(sse_traits_t<simd_integer>::preload_si128(ptr),
			sse_traits_t<simd_integer>::preload_si112((const char*)ptr + 16));
	}
	__SIMD_INLINE static simd_type preload_si256(const void* ptr) {
	...
	__SIMD_INLINE static __m128i getlow_si128(simd_type a) {
		return simd_cast<__m128i>(a);
	}
	
	__SIMD_INLINE static __m128i gethigh_si128(simd_type a) {
...
template<>
__SIMD_INLINE typename avx_traits_t<simd_integer>::simd_type 
