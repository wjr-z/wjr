...
template from_chars_result<> _from_chars_impl<default_writer<float>, chars_format>(
    const char *first, const char *last, default_writer<float> wr, chars_format fmt) noexcept;

template from_chars_result<> _from_chars_impl<default_writer<double>, chars_format>(
