        ...
        namespace biginteger {
            ...
            struct biginteger_traits {
                ...
                WJR_CONSTEXPR static unsigned char 
                    ...
                    return inc(cf, result + 1, lp + 1, n - 1);
                }
                ...
                WJR_CONSTEXPR static unsigned char
                    ...
                    return inc(cf, result + m, lp + m, n - m);
                }
                ...
                WJR_CONSTEXPR static unsigned char 
                    ...
                    return dec(cf, result + 1, lp + 1, n - 1);
                }
...
#pragma GCC unroll(4)
            ...
            struct __unsigned_biginteger_view {
                ...
                constexpr decltype(auto) operator()(const unsigned_biginteger<base>& val, size_t _Pos, size_t _Size) const {
                    return unsigned_biginteger_view<base>(val, _Pos, _Size);
                }
            ...
            struct __signed_biginteger_view {
                ...
                constexpr decltype(auto) operator()(const unsigned_biginteger<base>& val, size_t _Pos, size_t _Size) const {
                    return signed_biginteger_view<base>(val, _Pos, _Size);
                }
                ...
                constexpr decltype(auto) operator()(const biginteger<base>& val, size_t _Pos, size_t _Size) const {
                    return signed_biginteger_view<base>(val, _Pos, _Size);
                }
            ...
            public:
                using traits = biginteger_traits<base>;
                unsigned_biginteger_modifier(
                    unsigned_biginteger<base>& it,
                    size_t _pos,
                    size_t _size
                ) noexcept : m_ptr(std::addressof(it)), m_offset(_pos), m_size(_size) {
                    WASSERT_LEVEL_2(m_offset + m_size <= it.size());
                }
                unsigned_biginteger_modifier(const unsigned_biginteger_modifier&) = default;
                unsigned_biginteger_modifier& operator=(const unsigned_biginteger_modifier&) = default;
                unsigned_biginteger<base>* operator->() {
                    return m_ptr;
                }
                const unsigned_biginteger<base>* operator->() const {
                    return m_ptr;
                }
                limb_ptr data() {
                    WASSERT_LEVEL_2(m_offset + m_size <= m_ptr->size());
            ...
            struct __unsigned_biginteger_modifier {
                constexpr decltype(auto) operator()(unsigned_biginteger<base>& val) {
                    return unsigned_biginteger_modifier<base>(val, 0, val.size());
                }
                constexpr decltype(auto) operator()(unsigned_biginteger<base>& val, size_t _Pos, size_t _Size) {
                    return unsigned_biginteger_modifier<base>(val, _Pos, _Size);
                }
            };
    ...
    template<typename T, typename U,std::enable_if_t<                                           \
            ...
            private:
                ...
                static WJR_CONSTEXPR20 bool __Equal(const T& lhs, const U& rhs) {
                    ...
                    else if constexpr (im == 2) {
                        return p[0] == q[0] && p[1] == q[1];
                    }
                    else if constexpr (im == 3) {
                        return p[0] == q[0] && p[1] == q[1] && p[2] == q[2];
                    }
                    else if constexpr (im == 4) {
                ...
                static WJR_CONSTEXPR20 bool __Less(const T& lhs, const U& rhs) {
                    ...
                    if constexpr (im == 1) {
                        ...
                        return p[3] != q[3] ? p[3] < q[3] : p[2] != q[2] ? p[2] < q[2] : p[1] != q[1] ? p[1] < q[1] : p[0] < q[0];
                    }
                    else {
            ...
            private:
                ...
                WJR_CONSTEXPR20 static void CAdd(
                    ...
                    REGISTER_BIGINTEGER_FUNCTION(U::max_bit, rhs, QAdd, result, lhs, rhs);
                }
                ...
                WJR_CONSTEXPR20 static void Add(
                    ...
                    REGISTER_BETTER_BIGINTEGER_FUNCTION(T::max_bit, U::max_bit, CAdd, result, lhs, rhs);
                }
                ...
                WJR_CONSTEXPR20 static void Sub(
                    ...
                    REGISTER_BIGINTEGER_FUNCTION(U::max_bit, rhs, QSub, result, lhs, rhs);
                }
            ...
            WJR_CONSTEXPR20 void unsigned_biginteger<base>::QAdd(
                ...
                if constexpr (index != 0) {
                    ...
                    if constexpr (index >= 2) {
                        cf = traits::adc(cf, rep + 1, lp[1], rp[1]);
                    }
                    if constexpr (index >= 3) {
                        cf = traits::adc(cf, rep + 2, lp[2], rp[2]);
                    }
                    if constexpr (index >= 4) {
                        cf = traits::adc(cf, rep + 3, lp[3], rp[3]);
                    }
                }
                else {
            ...
            WJR_CONSTEXPR20 void unsigned_biginteger<base>::QSub(
                ...
                if constexpr (index != 0) {
                    ...
                    if constexpr (index >= 2) {
                        cf = traits::sbb(cf, rep + 1, lp[1], rp[1]);
                    }
                    if constexpr (index >= 3) {
                        cf = traits::sbb(cf, rep + 2, lp[2], rp[2]);
                    }
                    if constexpr (index >= 4) {
                        cf = traits::sbb(cf, rep + 3, lp[3], rp[3]);
                    }
                }
                else {
            ...
            WJR_CONSTEXPR20 void unsigned_biginteger<base>::slow_mul(
                ...
                if constexpr (index == 1) {
                    ...
                    auto rep = temp_array;
                    rep[ls] = traits::mul(rep, lp, ls, *rp);
                    ++rep;
                    ++rp;
                    --rs;
                    if constexpr (index >= 2) {
                        rep[ls] = traits::addmul(rep, lp, ls, *rp);
                        ++rep;
                        ++rp;
                        --rs;
                    }
            ...
            WJR_CONSTEXPR20 void unsigned_biginteger<base>::pos_add(
                ...
                unsigned char cf = 0;
                for (; i < m; ++i) {
                    cf = traits::adc(cf, result + i, result[i], rp[i]);
                }
                if (cf) {
            ...
            WJR_CONSTEXPR20 void unsigned_biginteger<base>::karatsuba(
                ...
                if (l != B.size()) {
                    pos_add(rep + 2 * mid, unsigned_view<base>(B, l, B.size() - l));
                }
                l = C.size() < mid ? C.size() : mid;
                std::copy_n(C.data(), l, rep);
                if (l != C.size()) {
                    pos_add(rep + mid, unsigned_view<base>(C, l, C.size() - l));
                }
                result.maintain();
            }
            ...
            WJR_CONSTEXPR20 void unsigned_biginteger<base>::dac_mul(
                ...
                mul(temp, g, rhs);
                pos_add(r.data() + i * l, unsigned_view<base>(temp));
                if constexpr (i == index - 1) {
                    result = std::move(r);
                    result.maintain();
                }
            ...
            WJR_CONSTEXPR20 void unsigned_biginteger<base>::dac_mul(
                ...
                if constexpr (index != 0) {
                    ...
                    for (size_t i = 0; i < idx; ++i) {
                        ...
                        auto g = unsigned_view<base>(lhs, i * m, s);
                        g.maintain();
                        mul(temp, g, rhs);
                        pos_add(r.data() + i * m, unsigned_view<base>(temp));
                    }
                    result = std::move(r);
                    result.maintain();
                }
...
#define BIGINTEGER_VIEW_BINARY_AUTO_DEFINITION                                                  \
    template<typename T, typename U, size_t _Base,                                              \
                    ...
                    for (size_t j = m + 1; j--; --pl) {
                        ...
                        if (r.size() == n + 1) {
                            q = std::min(traits::max(),
                                static_cast<limb_t>((traits::max_value() * pr[n] + pr[n - 1]) / _Divider2));
                            mul(temp, rhs, q);
                            auto cf = traits::sub(r.data(), r.data(), r.size(), temp.data(), temp.size());
                            if (cf) {
                                do {
                                    --q;
                                    cf = traits::add(r.data(), r.data(), r.size(), rhs.data(), rhs.size());
                                } while (!cf);
                            }
                            r.maintain();
                        }
                            ...
                            if (pr[n - 1] > val) {
                                ...
                                q = 1;
                                auto cf = traits::sub(r.data(), r.data(), r.size(), rhs.data(), rhs.size());
                                if (cf) {
                                    q = 0;
                                    traits::add(r.data(), r.data(), r.size(), rhs.data(), rhs.size());
                                }
                            }
                        }
            ...
            WJR_CONSTEXPR20 void unsigned_biginteger<base>::toom_cook_3(
                ...
                if (l != W1.size()) {
                    pos_add(result.data() + 3 * n3, signed_view<base>(W1, l, W1.size() - l));
                }
                l = W0.size() < n3 ? W0.size() : n3;
                std::copy_n(W0.data(), l, result.data());
                if (l != W0.size()) {
                    pos_add(result.data() + n3, signed_view<base>(W0, l, W0.size() - l));
                }
                result.maintain();
            }
