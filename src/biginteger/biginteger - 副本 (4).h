        ...
        namespace biginteger {
            ...
            struct biginteger_traits {
                ...
                WJR_CONSTEXPR static unsigned char
                    ...
                    if constexpr (!tag::same_address_tag(C{})) {
                        if (likely(lp != result)) {
...
#define REGISTER_BETTER_BIGINTEGER_FUNCTION(il,ir,FUNC,...)                                         \
        if constexpr(ir == 1){                                                                      \
	...
	template<typename T, typename U, typename C = tag::empty, std::enable_if_t<                 \
            ...
            private:
                ...
                WJR_CONSTEXPR20 static void Add(
                    ...
                    REGISTER_BETTER_BIGINTEGER_FUNCTION(T::max_bit, U::max_bit, CAdd, modifier, lhs, rhs, C{});
                }
            ...
            WJR_CONSTEXPR20 void unsigned_biginteger<base>::QAdd(
                ...
                if constexpr (!tag::reserved_tag(C{})) {
                    ...
                    return QAdd<index>(modifier, lhs, rhs, C{} | tag::reserved_tag);
                }
                else {
                    WASSERT_LEVEL_1(modifier.size() >= lhs.size());
            ...
            WJR_CONSTEXPR20 void unsigned_biginteger<base>::QSub(
                ...
                if constexpr (!tag::reserved_tag(C{})) {
                    ...
                    return QSub<index>(modifier, lhs, rhs, C{} | tag::reserved_tag);
                }
                else {
					WASSERT_LEVEL_1(modifier.size() >= lhs.size());
                    auto rep = modifier.data();
                ...
                WJR_CONSTEXPR20 static void knuth_divmod(biginteger& lhs, biginteger& rhs) {
                    ...
                    for (size_t j = m + 1; j--; --pl) {
                        ...
                        if (mr.size() == n + 1) {
                            ...
                            if (mr.data()[n - 1] > val) {
                                q = 1;
                                unsigned_traits::sub(mr, mr, rhs.ubint, 
                                    tag::same_address_tag | tag::reserved_tag);
                            }
